...
// Then go to http://jsonlint.com/ and paste it into the validator. Does it pass the test of being valid JSON? Yes it does pass the test of being valid JSON.
...
// Then, convert `grungeAlbumsJSON` back into a JavaScript object, and compare it to the original `grungeAlbums`. Are they the same? No there are not. how ever it kind close to each other same data but diferent format.
...
JSON.stringify(grungeAlbumsJSON);
{
  "albums":[
    {
        "name": "Bleach",
